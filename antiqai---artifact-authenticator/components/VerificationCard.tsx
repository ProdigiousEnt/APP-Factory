          ...
          <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-4 border-2 border-green-200 mb-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <h4 className="font-bold text-green-900 text-sm uppercase">Estimated Market Value</h4>
              </div>
              <div className="text-2xl font-bold text-green-700">{analysis.estimatedValue}</div>
            </div>
            <p className="text-xs text-green-700 mt-2 italic">Based on current market conditions and typical condition</p>
          </div>
